...
import AuthSectionSeparator from "../auth-section-separator";
import OAuthStrategyList, { OAuthStrategyButtonVariants } from "../oauth-strategy-list";
      ...
      <Card className="w-full sm:w-96 p-3">
        ...
        <CardFooter className="flex flex-col w-full gap-y-4">
          ...
          <Button variant="link" size="sm" asChild>
            ...
            >
              Already have an account? <span className="text-accent-foreground">Sign in</span>
            </Link>
          </Button>
        </CardFooter>
      </Card>
